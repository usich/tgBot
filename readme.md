...
- В .gitignore файл config.py, в котором находиться: token бота, api key yandex диска, логин и пароль для доступа к некоторым ресурсам из ip_list (те ресурсы у которых в value имеется 3 элемент списка)